...
namespace Perfectial.DataAccess.Implementation
{
    ...
    public class DbContextCollection : IDbContextCollection
    {
        ...
        private Dictionary<IDbContext, Perfectial.DataAccess.Interfaces.IDbTransaction> _transactions; 
        ...
        public DbContextCollection(bool readOnly = false, IsolationLevel? isolationLevel = null, IDbContextFactory dbContextFactory = null)
        {
            ...
            _transactions = new Dictionary<IDbContext, Perfectial.DataAccess.Interfaces.IDbTransaction>();
